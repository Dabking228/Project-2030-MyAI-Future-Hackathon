"""
generate_carbon_doc.py
----------------------
Auto-generates carbon-methodology.md from the Backend config values.
Run once whenever emission factors are updated.

    python rag_data/setup_and_maintenance/generate_carbon_doc.py
"""

import os

CONTENT = """# SYBAR_AI Carbon Emission Methodology
...
with open("rag_data/carbon-methodology.md", "w", encoding="utf-8") as f:
    f.write(CONTENT)

print("Written: rag_data/carbon-methodology.md")
